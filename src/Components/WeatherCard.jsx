...
const WeatherCard = () => {
    ...
    const { data: currentWeather, error: weatherError, isLoading } = useGetCurrentWeatherQuery(`${lat},${long}`);
            ...
            <Grid container direction='column' sx={{ borderRadius: '16px', overflow: 'hidden' }}>
                <Grid item md={12} xs={12} sm={12} p={1} sx={{ background: '#FF4ADE' }}>
                    <Grid container justifyContent='space-around' alignItems='center'>
                        <Typography variant='h6' sx={{ color: '#fff', fontWeight: '600' }}>02-03-2023</Typography>
                        <Typography variant='h6' sx={{ color: '#fff', fontWeight: '600' }}>04:15 PM</Typography>
                    </Grid>
                </Grid>
