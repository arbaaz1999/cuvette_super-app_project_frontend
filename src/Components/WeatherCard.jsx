...
import { Grid, styled, Typography, CircularProgress, Box } from '@mui/material';
...
const WeatherCard = () => {
    ...
    const { data: currentWeather, isLoading } = useGetCurrentWeatherQuery(`${lat},${long}`);
    console.log('current weather is ', currentWeather)

    const getUserCoordinates = () => {
        geolocationAPI.getCurrentPosition((positions) => {
